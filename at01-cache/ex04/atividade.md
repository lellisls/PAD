Utilize uma função para multiplicação de matrizes do ATLAS (http://math-atlas.sourceforge.net/) com as otimizações possíveis disponíveis na biblioteca e refaça os experimentos.
